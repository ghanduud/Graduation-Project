...
urlpatterns = [
    ...
    path('ad_dashboard_data/', views.ad_dashboard_data),
    path('ad_notice/', views.ad_notice),
    ...
    path('ad_view_students_class/<str:cl>/', views.ad_view_students_class),

    path('ad_add_notice/', views.ad_add_notice),

    path('teach_dashboard/<int:user_id>/', views.teach_dashboard),

    path('stud_dashboard/<int:user_id>/', views.stud_dashboard),
    path('stud_attendance/<int:user_id>/<str:date>/', views.stud_attendance),
